              ...
              <Grid item key={card.id} xs={12} sm={6} md={4}>
                <Card className={classes.card} style={{backgroundColor:"#F3E0E0"}}>
                  ...
                  <CardContent className={classes.cardContent}>
                    ...
                    <Link style={{align:"center",marginLeft:'30px',marginRight:'30px',color:'black'}} 
                    href={`/Customer/ProductDetails/${card.id}`}
                    addItem={props.addItem}
                    card={card}
                   

                    // path="/ProductDetails" 
                    to={`/Customer/ProductDetails/${card.id}`}
                    
                  //    to={{
                  //  pathname:"/ProductDetails"}}
                  //  aboutProps:{
                  //   prod: card,
                  //   title:"helllo from app"
                  // }
            // }}
                  // to="/ProductDetails"
                ...
                //  state={{ prod: card }}
                  ...
                  // component={ProductDetails}
                   ...
                   >  
                    ...
                    <Typography>  
                      <Link href={`/Customer/ProductDetails/${card.id}`} to={`/Customer/ProductDetails/${card.id}`}  addItem={props.addItem}
                    card={card}><button>View </button></Link>                              
                    </Typography>
                  </CardContent>
                  <CardActions> 
                  <Typography>                
